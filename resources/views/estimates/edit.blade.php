    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 dark:border-gray-700 transition-all duration-300 hover:shadow-2xl">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                    {{ __('Update the estimate details below.') }}
                                </p>
                            </div>
                        </div>
                ...
                <form action="{{ route('estimates.update', $estimate) }}" method="POST" class="p-8" x-data="{
                    items: {{ Js::from($estimate->items->map(function($item) {
                        return [
                            'title' => $item->title,
                    ...
                    taxRate: {{ $estimate->tax ?? 0 }},
                    discountRate: {{ $estimate->discount ?? 0 }},
                    discountType: '{{ $estimate->discount_type ?? 'percent' }}',
                    currencySymbol: '{{ $estimate->branch->currency ?? $settings['currency_symbol'] ?? '$' }}',
                    addItem() {
                    ...
                    <div class="space-y-10">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input id="estimate_number" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 focus:bg-white dark:focus:bg-gray-900 transition-all" type="text" name="estimate_number" :value="old('estimate_number', $estimate->estimate_number)" required />
                                    </div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <select id="branch_id" name="branch_id" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:bg-white dark:focus:bg-gray-900 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm transition-all">
                                                ...
                                                @foreach($branches as $branch)
                                                    <option value="{{ $branch->id }}" {{ old('branch_id', $estimate->branch_id) == $branch->id ? 'selected' : '' }}>{{ $branch->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <select id="client_id" name="client_id" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:bg-white dark:focus:bg-gray-900 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm transition-all" required>
                                            ...
                                            @foreach($clients as $client)
                                                <option value="{{ $client->id }}" {{ old('client_id', $estimate->client_id) == $client->id ? 'selected' : '' }}>{{ $client->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <select id="project_id" name="project_id" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:bg-white dark:focus:bg-gray-900 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm transition-all">
                                            ...
                                            @foreach($projects as $project)
                                                <option value="{{ $project->id }}" {{ old('project_id', $estimate->project_id) == $project->id ? 'selected' : '' }}>{{ $project->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input id="valid_until" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 focus:bg-white dark:focus:bg-gray-900 transition-all" type="date" name="valid_until" :value="old('valid_until', $estimate->valid_until ? \Carbon\Carbon::parse($estimate->valid_until)->format('Y-m-d') : '')" required />
                                    </div>
                        ...
                        <div class="flex items-center justify-end mt-8 border-t border-gray-100 dark:border-gray-700 pt-6">
                            <a href="{{ route('estimates.index') }}" class="text-gray-700 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 mr-6 font-medium" wire:navigate>Cancel</a>
