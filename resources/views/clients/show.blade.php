        ...
        <div class="max-w-[98%] mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 border-b border-gray-200 dark:border-gray-700">
                <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                    ...
                    <button @click="activeTab = 'team'" :class="{ 'border-indigo-500 text-indigo-600 dark:text-indigo-400': activeTab === 'team', 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300': activeTab !== 'team' }" class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors duration-200 flex items-center">
                        Team
            ...
            <!-- Team Tab -->
            <div x-show="activeTab === 'team'" class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg" x-cloak>
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    @if($client->users->isEmpty())
                        <p class="text-gray-500">No team members found for this client.</p>
                    @else
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gray-50 dark:bg-gray-700">
