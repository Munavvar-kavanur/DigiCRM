    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 dark:border-gray-700 transition-all duration-300 hover:shadow-2xl">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                    {{ __('Create and send a new invoice to your client.') }}
                                </p>
                            </div>
                        </div>
                ...
                <form action="{{ route('invoices.store') }}" method="POST" class="p-8" x-data="{
                    ...
                    updateCurrency(e) {
                        ...
                        if (branchId && branchCurrencies[branchId]) {
                            this.currencySymbol = branchCurrencies[branchId];
                        } else {
                    ...
                    <div class="space-y-10">
                        ...
                        <section class="relative">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input id="invoice_number" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 focus:bg-white dark:focus:bg-gray-900 transition-all" type="text" name="invoice_number" :value="old('invoice_number')" placeholder="Leave empty to auto-generate (e.g. INV-DXB-0001)" />
                                    </div>
                                ...
                                @if(auth()->user()->isSuperAdmin())
                                    ...
                                    <div class="group">
                                        ...
                                        <div class="relative">
                                            ...
                                            <select id="branch_id" name="branch_id" @change="updateCurrency" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:bg-white dark:focus:bg-gray-900 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm transition-all">
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input id="issue_date" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 focus:bg-white dark:focus:bg-gray-900 transition-all" type="date" name="issue_date" :value="old('issue_date', date('Y-m-d'))" required />
                                    </div>
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input id="due_date" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 focus:bg-white dark:focus:bg-gray-900 transition-all" type="date" name="due_date" :value="old('due_date')" required />
                                    </div>
                            ...
                            <!-- Recurring Options -->
                            <div class="mt-6 p-4 bg-gray-50 dark:bg-gray-700/30 rounded-lg border border-gray-100 dark:border-gray-700" x-data="{ isRecurring: false }">
                    ...
                    <div class="flex items-center justify-end gap-4 mt-10 pt-6 border-t border-gray-100 dark:border-gray-700">
                        <a href="{{ route('invoices.index') }}" class="px-6 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all">
                            Cancel
                        </a>
