                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input id="invoice_number" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 focus:bg-white dark:focus:bg-gray-900 transition-all" type="text" name="invoice_number" :value="old('invoice_number', $nextInvoiceNumber)" required />
                                    </div>
