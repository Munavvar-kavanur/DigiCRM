            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 dark:border-gray-700 transition-all duration-300 hover:shadow-2xl">
                ...
                <div class="px-8 py-6 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-700/20 backdrop-blur-sm">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="hidden md:block">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-teal-100 text-teal-800 dark:bg-teal-900/50 dark:text-teal-300">
                                Editing Mode
                            </span>
                        </div>
                    </div>
                ...
                <form method="POST" action="{{ route('employees.update', $employee) }}" class="p-8">
                    ...
                    <div x-data="{ 
                        ...
                        selectedType: '{{ old('payroll_type_id', $employee->payroll_type_id) }}',
                        get salaryLabel() {
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input id="name" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:bg-white dark:focus:bg-gray-900 focus:border-teal-500 focus:ring-teal-500 transition-all" type="text" name="name" :value="old('name', $employee->name)" required autofocus />
                                    </div>
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input id="email" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:bg-white dark:focus:bg-gray-900 focus:border-teal-500 focus:ring-teal-500 transition-all" type="email" name="email" :value="old('email', $employee->email)" required />
                                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input id="joining_date" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:bg-white dark:focus:bg-gray-900 focus:border-teal-500 focus:ring-teal-500 transition-all" type="date" name="joining_date" :value="old('joining_date', $employee->joining_date ? $employee->joining_date->format('Y-m-d') : '')" />
                                    </div>
                                ...
                                <div class="group" x-show="showSalary" 
                                    ...
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            <span class="text-gray-500 font-bold">{{ $employee->branch ? $employee->branch->currency : '$' }}</span>
                                        </div>
                                        <x-text-input id="salary" class="block w-full pl-8 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:bg-white dark:focus:bg-gray-900 focus:border-teal-500 focus:ring-teal-500 transition-all" type="number" step="0.01" name="salary" :value="old('salary', $employee->salary)" placeholder="0.00" />
                                    </div>
