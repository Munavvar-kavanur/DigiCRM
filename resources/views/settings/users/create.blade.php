            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('settings.users.store') }}">
                        ...
                        <!-- Role -->
                        <div class="mt-4" x-data="{ role: '{{ old('role', 'branch_admin') }}' }">
                            ...
                            <!-- Branch Selection (Visible if Branch Admin) -->
                            <div class="mt-4" x-show="role === 'branch_admin'">
                                <x-input-label for="branch_id" :value="__('Assign Branch')" />
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <a href="{{ route('settings.users.index') }}" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800 mr-4">
                                {{ __('Cancel') }}
                            </a>
                            <x-primary-button>
                                {{ __('Create User') }}
