            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 dark:border-gray-700 transition-all duration-300 hover:shadow-2xl">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                    {{ __('Set up a new reminder for yourself or others.') }}
                                </p>
                            </div>
                        </div>
                ...
                <form method="POST" action="{{ route('reminders.store') }}" class="p-8">
                    ...
                    <div class="space-y-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div class="group md:col-span-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input id="title" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 focus:bg-white dark:focus:bg-gray-900 focus:border-amber-500 focus:ring-amber-500 transition-all" type="text" name="title" :value="old('title')" required autofocus placeholder="e.g., Follow up with client" />
                                    </div>
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input id="reminder_date" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 focus:bg-white dark:focus:bg-gray-900 focus:border-amber-500 focus:ring-amber-500 transition-all" type="date" name="reminder_date" :value="old('reminder_date')" required />
                                    </div>
                                ...
                                <div class="group md:col-span-2">
                                    ...
                                    <textarea id="description" name="description" rows="3" class="block w-full bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 focus:bg-white dark:focus:bg-gray-900 focus:border-amber-500 focus:ring-amber-500 rounded-md shadow-sm transition-all" placeholder="Add any additional details...">{{ old('description') }}</textarea>
                        ...
                        <!-- Recurring Options -->
                        <div x-data="{ isRecurring: {{ old('is_recurring') ? 'true' : 'false' }} }" class="bg-gray-50 dark:bg-gray-700/30 p-6 rounded-xl border border-gray-100 dark:border-gray-700">
                            <div class="flex items-center">
                                <input id="is_recurring" type="checkbox" name="is_recurring" value="1" class="w-4 h-4 text-amber-600 border-gray-300 rounded focus:ring-amber-500 dark:focus:ring-amber-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600" x-model="isRecurring">
