                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                    {{ __('Start a new project and assign it to a client.') }}
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 gap-8">
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input id="title" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:bg-white dark:focus:bg-gray-900 transition-all" type="text" name="title" :value="old('title')" placeholder="e.g. Website Redesign" required autofocus />
                                    </div>
                                            ...
                                            if (branchSelect && currencyDisplay) {
                                                branchSelect.addEventListener('change', function() {
                                                    ...
                                                    if (branchId && branchCurrencies[branchId]) {
                                                        ...
                                                        currencyDisplay.textContent = '{{ \App\Models\Setting::get('currency_symbol', '$') }}';
                                                    }
                                                });
                                            }
                                        });
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input id="deadline" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:bg-white dark:focus:bg-gray-900 transition-all" type="date" name="deadline" :value="old('deadline')" />
                                    </div>
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            <span id="currency-display" class="text-gray-400 group-focus-within:text-indigo-500 transition-colors font-bold">{{ \App\Models\Setting::get('currency_symbol', '$') }}</span>
                                        </div>
                                        <x-text-input id="budget" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:bg-white dark:focus:bg-gray-900 transition-all" type="number" step="0.01" name="budget" :value="old('budget')" placeholder="0.00" />
                                    </div>
