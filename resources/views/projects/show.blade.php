                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex justify-end space-x-2">
                                                <button type="button" @click="$dispatch('open-delete-modal', { actionUrl: '{{ route('tasks.destroy', $task) }}' })" class="text-red-600 hover:text-red-900 dark:hover:text-red-400 transition-colors duration-200" title="Delete Task">
