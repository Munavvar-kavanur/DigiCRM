                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                    {{ __('Update the expense details below.') }}
                                </p>
                            </div>
                        </div>
                ...
                <form action="{{ route('expenses.update', $expense) }}" method="POST" enctype="multipart/form-data" class="p-8">
                    ...
                    <div class="space-y-10">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div class="group md:col-span-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input id="title" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:bg-white dark:focus:bg-gray-900 transition-all" type="text" name="title" :value="old('title', $expense->title ?? $expense->description)" required autofocus />
                                    </div>
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            <span class="text-gray-500 font-bold">{{ $expense->branch->currency ?? $settings['currency_symbol'] ?? '$' }}</span>
                                        </div>
                                        <x-text-input id="amount" class="block w-full pl-8 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:bg-white dark:focus:bg-gray-900 transition-all" type="number" step="0.01" name="amount" :value="old('amount', $expense->amount)" required />
                                    </div>
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input id="date" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:bg-white dark:focus:bg-gray-900 transition-all" type="date" name="date" :value="old('date', $expense->date->format('Y-m-d'))" required />
                                    </div>
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input id="merchant" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:bg-white dark:focus:bg-gray-900 transition-all" type="text" name="merchant" :value="old('merchant', $expense->merchant)" />
                                    </div>
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input id="reference" class="block w-full pl-10 bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:bg-white dark:focus:bg-gray-900 transition-all" type="text" name="reference" :value="old('reference', $expense->reference)" />
                                    </div>
                        ...
                        <section class="relative">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div class="group md:col-span-2">
                                    ...
                                    @if($expense->receipt_path)
                                        <div class="mb-4 p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-xl border border-indigo-100 dark:border-indigo-800 flex items-center justify-between group/file">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    <p class="text-sm font-medium text-gray-900 dark:text-gray-100">Current Receipt</p>
                                                    <p class="text-xs text-gray-500 dark:text-gray-400">Click view to open file</p>
                                                </div>
                                            </div>
                                            <a href="{{ asset('storage/' . $expense->receipt_path) }}" target="_blank" class="px-4 py-2 bg-white dark:bg-gray-800 text-indigo-600 dark:text-indigo-400 text-sm font-medium rounded-lg shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                                View File
                                            </a>
                                        </div>
                                    @endif
                            ...
                            <!-- Recurring Settings -->
                            <div class="mt-8 p-6 bg-gray-50 dark:bg-gray-700/30 rounded-xl border border-gray-100 dark:border-gray-700" x-data="{ show: {{ old('is_recurring', $expense->is_recurring) ? 'true' : 'false' }} }">
                                <div class="flex items-center">
                                    <input id="is_recurring" name="is_recurring" type="checkbox" class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600" {{ old('is_recurring', $expense->is_recurring) ? 'checked' : '' }} @change="show = !show">
                                ...
                                <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6" x-show="show" x-transition>
                                    <div>
                                        ...
                                        <select id="frequency" name="frequency" class="block w-full bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm transition-all">
                                            ...
                                            <option value="half_yearly" {{ old('frequency', $expense->frequency) == 'half_yearly' ? 'selected' : '' }}>Half Yearly</option>
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="end_date" name="end_date" type="date" class="block w-full bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm transition-all" :value="old('end_date', $expense->end_date ? $expense->end_date->format('Y-m-d') : '')" />
                                    </div>
                                </div>
                            </div>
                        </section>
